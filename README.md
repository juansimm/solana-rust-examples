# Solana Rust by Example

This is a library of Rust scripts for specific purposes:

- [Solana Rust by Example](#solana-rust-by-example)
  - [New wallet](#new-wallet)
  - [Create an SPL token](#create-an-spl-token)
  - [Mint SPL tokens](#mint-spl-tokens)
  - [Get token balance](#get-token-balance)
  - [Get account creation timestamp](#get-account-creation-timestamp)
  - [Get NFT owner](#get-nft-owner)
